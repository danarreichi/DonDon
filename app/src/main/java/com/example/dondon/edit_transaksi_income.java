...
public class edit_transaksi_income extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_transaksi_income);
        ...
        spinner_data_kategori.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (tambah == "Tambah Kategori...") {
                    Intent pindah = new Intent(edit_transaksi_income.this, tambah_kategori_income.class);
