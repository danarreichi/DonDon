...
public class tambah_kategori_expense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_kategori_expense);
        ...
        button_tambah_kategori.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edit_text_kategori.getText().toString().matches("")) {
                    ...
                    db.execSQL("INSERT INTO MASTER_KATEGORI VALUES(" + temp_ID + ", '" + edit_text_kategori.getText().toString() + "', 'keluar')");
                    finish();
                }
            }
        });
